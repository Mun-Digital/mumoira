...
if (isset($_POST['LuuNganHang'])) {
    ...
    if ($isUpdate) {
        $DB->insert("logs", [
            ...
            'createdate'    => time(),
            'action'        => "Cập nhật thông tin ngân hàng (".$_POST['short_name']." - ".$_POST['accountNumber'].") vào hệ thống."
        ]);
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body p-0">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($DB->get_list("SELECT * FROM `banks`  ") as $bank) {?>
                                    <tr>
                                        <td><?=$bank['id'];?></td>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="short_name" required>
                                        ...
                                        <option <?=$row['short_name'] == $bank['bank_id'] ? 'selected' : '';?> value="<?=$bank['bank_id'];?>">
