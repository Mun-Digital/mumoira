...
$listDatatable = $DB->get_list(" SELECT * FROM `logs` WHERE $where ORDER BY `id` DESC LIMIT $from,$sotin1trang ");
?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <?php
                                $total = $DB->num_rows(" SELECT * FROM `logs` WHERE $where ORDER BY id DESC ");
